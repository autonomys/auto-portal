...
export type NominatorWithdrawalProps = Omit<NominatorWithdrawal, NonNullable<FunctionPropertyNames<NominatorWithdrawal>>| '_name'>;
...
export class NominatorWithdrawal implements Entity {
     ...
     * */
    static async getByFields(filter: FieldsExpression<NominatorWithdrawalProps>[], options?: GetOptions<NominatorWithdrawalProps>): Promise<NominatorWithdrawal[]> {
