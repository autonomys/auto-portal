...
export type StorageFundAccountProps = Omit<StorageFundAccount, NonNullable<FunctionPropertyNames<StorageFundAccount>>| '_name'>;
...
export class StorageFundAccount implements Entity {
     ...
     * */
    static async getByFields(filter: FieldsExpression<StorageFundAccountProps>[], options?: GetOptions<StorageFundAccountProps>): Promise<StorageFundAccount[]> {
