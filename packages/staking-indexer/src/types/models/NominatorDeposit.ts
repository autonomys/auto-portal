...
export type NominatorDepositProps = Omit<NominatorDeposit, NonNullable<FunctionPropertyNames<NominatorDeposit>>| '_name'>;
...
export class NominatorDeposit implements Entity {
     ...
     * */
    static async getByFields(filter: FieldsExpression<NominatorDepositProps>[], options?: GetOptions<NominatorDepositProps>): Promise<NominatorDeposit[]> {
